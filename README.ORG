...
* GIT
** Assemble patches
   git format-patch CURRENT_COMMIT_HASH -o /some/folder
** Apply patches
   git am --ignore-whitespace --3way --keep-non-patch *.patch
...
** How to check which package own file
...
** Disconnect container from network
   ...
   docker network disconnect -f bridge build
